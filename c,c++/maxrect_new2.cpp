...
int main(){
	...
	long long int max_col,max_row,b[301]={0},c[301]={0},maximum,sum,total_row=0,total_col=0;
...
//	ans_col.resize(col);
	...
	if(total_row>=total_col && total_row>0){
	...
	else if(total_row<total_col && total_col>0){
